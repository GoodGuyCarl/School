                            ...
                            <form class="row justify-content-center" method="POST" action="{{route('adminupdate', $user->id)}}">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <select class="form-select mb-2" name="year_level" aria-label="Year Level">
                                        <option value="{{$user->year_level}}" disabled selected>{{$user->year_level}}</option>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <select id="vax_status" class="form-select mb-2" name="vaccination_status">
                                        <option disabled>Vaccination Status</option>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input id="enroll_date" type="date" class="form-control mb-2" name="enrollment_date">
                                </div>
                                <div class="col-md-5">
