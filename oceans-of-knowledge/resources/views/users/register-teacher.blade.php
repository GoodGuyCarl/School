    ...
    <main class="poppins pb-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="modal fade" id="myModal">
                    <div class="modal-lg modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header bg-prussian-blue">
                                <h3 class="modal-title text-white">Oceans of Knowledge Privacy Policy</h3>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>
                            <div class="modal-body">
                                <p>Your privacy is important to us. It is Oceans of Knowledge&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://www.oceansofknowledge.com">https://www.oceansofknowledge.com</a>, and other sites we own and operate. </p>
                                <p>This policy is effective as of 12 December 2022 and was last updated on 12 December 2022. </p>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-hover" data-bs-dismiss="modal">Close</button>
                            </div>
                ...
                <div class="col-lg-5">
                    <div class="card">
                        <h3 class="card-header bg-prussian-blue text-center text-white fw-bold p-4">Create teacher account</h3>
                        <div class="card-body">
